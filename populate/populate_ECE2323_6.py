...
def populate(ee_science_ii):
    ...
    add_simulation_element(simulation=dsof_simulation,
                           ...
                           text_input="(Use circuit comparator for this circuit) Vin to be a 1kHz step input, Let R=10 ohm, C=1nF, and L=1mH. )Consider the circuit in Fig. 3. For this circuit, determine the characteristic equation of this circuit "+
